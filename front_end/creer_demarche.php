                            ...
                            <div class="card-body">
                                ...
                                <div class="card">
                                  <p class="card-title">Entreprise choisie</p>
                                    ...
                                    <form method="POST" href="stage/front_end/tdb_etudiant.php" class="mt-4">
                                        <button type="submit" name="stop_demarche" id="stop_demarche"class="btn btn-danger">Stop Démarche</button>
                                            <?php if(isset($_POST['stop_demarche'])){
                                                $c =$db->prepare("UPDATE `entreprise` SET `REFUS_ANNEESIO1`=1,`REFUS_ANNEE_SIO2`=1 WHERE NOM_ENTREPRISE = ?");
                                                $c->execute(array($entreprise['NOM_ENTREPRISE']));
